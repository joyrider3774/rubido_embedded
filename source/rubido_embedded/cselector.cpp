...
{
	drawRect(XOffSet - 1 + Selector->CurrentPoint.X * (TileWidth), YOffSet - 1 + Selector->CurrentPoint.Y * (TileHeight), (TileWidth + 2), (TileHeight + 2), ColorForeground);
	drawRect(XOffSet + Selector->CurrentPoint.X * (TileWidth), YOffSet+ Selector->CurrentPoint.Y * (TileHeight), TileWidth, TileHeight, ColorBackground);
	drawRect(XOffSet + 1 + Selector->CurrentPoint.X * (TileWidth), YOffSet + 1 + Selector->CurrentPoint.Y * (TileHeight), (TileWidth-2), (TileHeight-2), ColorBackground);
	drawRect(XOffSet + 2 + Selector->CurrentPoint.X * (TileWidth), YOffSet + 2 + Selector->CurrentPoint.Y * (TileHeight), (TileWidth-4), (TileHeight-4), ColorForeground);
}
